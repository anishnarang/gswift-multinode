...
from swift.common.utils import ContextPool, hash_path, normalize_timestamp, \
...
logging.basicConfig(filename="/home/swift/swift.log",level=logging.INFO)
...
class ObjectController(Controller):
    ...
    def GETorHEAD(self, req):
        ...
        resp = self.GETorHEAD_base(
            ...
            req.swift_entity_path, self.account_name, self.container_name, self.object_name)
